...
@section('content')
  <div id="product_content" class="bg-white">
      <div class="container">
      <form action="{{route('hotlist_product.update')}}" id="form" method="post" enctype="multipart/form-data">
              @csrf 
              @method('PUT')
              <div class="row p-4">
                  <div class="col-md-7">
                  <input type="hidden" name="id" id="id" value="{{$product->id}}" class="form-control" placeholder="" aria-describedby="helpId">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                              <label for="part_no">Part Number <small>(if any)</small></label>
